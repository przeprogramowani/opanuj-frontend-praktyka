...
export const isValidInteger: StringValidationMethod = (value: string): boolean => {
    return value != '' && Number.isInteger(Number(value));
};

export const NUMBER_VALIDATORS: NumericValidationMethod[] = [isEven, isGreatherThan(0), isLessThan(100)];
