...
export const UserFriends = (user: User) => (
    <div className="flex bg-purple-800 text-white rounded-lg p-4">
        <div>
            ...
            {user.friends.length > 0 && <p className="border-t border-gray-200 mt-4 py-4">Friends:</p>}
...
export const DetailedUser = (user: User) => (
    <div className="flex bg-orange-800 text-white rounded-lg p-4">
        <div className="mr-4 flex-shrink-0">
            <img src={user.profilePictureUrl} className="w-8 h-8 rounded-full shadow-md" />
        </div>
        <div>
            <h4 className="text-lg font-bold">
                {user.firstName} {user.lastName}
            ...
            {user.follows.length > 0 && <p className="border-t border-gray-200 mt-4 py-4">👁️ Follows:</p>}
