        ...
        <div className="bg-white p-4 rounded-lg">
            ...
            <div className="my-4">
                ...
                <div className="flex flex-row space-x-2">
                    ...
                    <FilterButton label={'Friends > 0'} action={filterByFriends.bind(this, true)} />
                    <FilterButton label={'Friends = 0'} action={filterByFriends.bind(this, false)} />
                </div>
            </div>
...
export const FilterButton = ({ label, action }: FilterButtonProps) => (
    <button className="border border-gray-200 px-4 py-2 hover:bg-blue-200/20 rounded-xl" onClick={() => action()}>
        {label}
    </button>
);
