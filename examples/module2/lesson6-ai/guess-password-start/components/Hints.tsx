...
export const Hints = () => {
    ...
    const showNextHint = () => {
        setCurrentHintIndex(prevHintIndex => (prevHintIndex === -1 ? 0 : (prevHintIndex + 1) % hints.length));
    };
    ...
    return (
        <div>
            ...
            <button onClick={showNextHint} className="mt-2 bg-violet-600 text-white p-2 rounded hover:bg-violet-700">
                Pokaż podpowiedź
            </button>
        </div>
    );
