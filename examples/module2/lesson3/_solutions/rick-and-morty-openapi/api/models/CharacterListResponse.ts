...
export function CharacterListResponseFromJSON(
  json: any
): CharacterListResponse {
  return CharacterListResponseFromJSONTyped(json, false);
}

export function CharacterListResponseFromJSONTyped(
  json: any,
  ...
  return {
    info: !exists(json, 'info')
      ? undefined
      : CharacterListResponseInfoFromJSON(json['info']),
    results: !exists(json, 'results')
      ? undefined
      : (json['results'] as Array<any>).map(CharacterFromJSON),
  };
}

export function CharacterListResponseToJSON(
  value?: CharacterListResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    results:
      value.results === undefined
        ? undefined
        : (value.results as Array<any>).map(CharacterToJSON),
  };
}
