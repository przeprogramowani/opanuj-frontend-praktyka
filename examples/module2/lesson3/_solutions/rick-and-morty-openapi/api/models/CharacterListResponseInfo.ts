...
export function CharacterListResponseInfoFromJSON(
  json: any
): CharacterListResponseInfo {
  return CharacterListResponseInfoFromJSONTyped(json, false);
}

export function CharacterListResponseInfoFromJSONTyped(
  json: any,
...
export function CharacterListResponseInfoToJSON(
  value?: CharacterListResponseInfo | null
): any {
  if (value === undefined) {
    return undefined;
  }
