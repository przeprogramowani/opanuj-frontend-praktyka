...
const ERROR_MESSAGES = {
    ...
    ORIGIN_MAX_LENGTH: (limit: number) => `Nazwa lokalizacji początkowej nie może przekraczać ${limit} znaków`,
    DESTINATION_REQUIRED: 'Lokalizacja docelowa jest wymagana',
    DESTINATION_MAX_LENGTH: (limit: number) => `Nazwa lokalizacji docelowej nie może przekraczać ${limit} znaków`,
